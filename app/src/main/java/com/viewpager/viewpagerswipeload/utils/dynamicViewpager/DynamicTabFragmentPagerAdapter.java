...
public class DynamicTabFragmentPagerAdapter extends FragmentPagerAdapter {
   ...
   // private final ActionBar actionBar;
    ...
    public DynamicTabFragmentPagerAdapter( final Context context, final FragmentManager fm,
                                           final ViewPager pager){ //}, final ActionBar actionBar ) {
        super( fm );
   ...
   /* public void addPage( String title, Class<? extends Fragment> fragment ) {
    ...
    public void addPage(int pos, String title, Class<? extends Fragment> fragment, Bundle arguments ) {
        if( fragment != null ) {
            pages.add( pos, new PageInfo( fragment, title, arguments ) );
